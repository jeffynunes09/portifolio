...
const Hero = () => {
  return (
    <section className={`relative w-full h-[75vh] custom:h-[90vh] mx-auto`}>
      <div
        className={`absolute inset-0  max-w-7xl mx-auto ${styles.paddingX} flex flex-row items-start gap-5 top-[65px]`}
      >
